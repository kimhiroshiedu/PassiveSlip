%====================================================
function [triC,tri3,tri,sll]=Sasa_make_trill_rand
%====================================================
Fid=fopen('/home/sasajima/DATA/PAC_bound_Q.txt','r');
bound=textscan(Fid,'%f %f');
fclose(Fid);
bound=cell2mat(bound);
%====================================================
Fid=fopen('/home/sasajima/DATA/PACdw.txt','r');
dep_main=textscan(Fid,'%f %f %f');
fclose(Fid);
dep_main=cell2mat(dep_main);
%====================================================
Fid=fopen('/home/sasajima/DATA/Tohoku_nearC.txt','r');
...
%====================================================
%Fid=fopen('/home/sasajima/DATA/TohokuPACmesh2.dat','r');
